...
@section('content')
<div class="h-screen bg-slate-200 pt-[4rem]">
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <div class="bg-gray-50  border border-gray-200 rounded-lg p-8 md:p-12 mb-8">
                ...
                <h1 class="text-gray-900text-3xl md:text-5xl font-extrabold mb-2">How to quickly deploy
                    a static website</h1>
                <p class="text-lg font-normal text-gray-500 mb-6">Static websites are now used to
